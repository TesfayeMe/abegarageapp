        ...
        <footer className="main-footer">
                            ...
                            <div className="footer-column col-lg-4">
                                <div className="widget widget_newsletter">
                                    ...
                                    <div className="newsletter-form">
                                        <form className="ajax-sub-form" method="post">
                                            <div className="form-group">
                                                ...
                                                <button className="theme-btn" type="submit" style={{textAlign: 'center', height: '48px', top: '8px'}}>
                                                        <GrSend color='white' size={35}/>
                                                        </button>
                                    ...
                                    <ul className="social-links">
                                        <li><a href="#">
                                        <LiaFacebookF color='white' size={22}/> 
            ...
            <div className="auto-container">
                <div className="footer-bottom">
                    <div className="copyright-text">© Copyright <a href="#">Abe Garage</a> 2026 . All right reserved.</div>
                    <div className="text">Created by <a href="#">Tesfaye</a></div>
                </div>
            </div>
        </footer>
        {/*End Main Footer*/}
