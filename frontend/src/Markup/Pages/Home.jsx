...
import vban1 from '../../assets/assets/images/custom/misc/vban1.jpg';
import vban2 from '../../assets/assets/images/custom/misc/vban2.jpg';
import banner from '../../assets/assets/images/custom/banner/banner1.jpg'
import image3 from '../../assets/assets/images/resource/image-3.jpg'
import image4 from '../../assets/assets/images/resource/image-4.jpg'
import image1 from '../../assets/assets/images/background/bg-1.jpg'
import './home.css'
const Home = () => {
  return (
    <div>
            ...
            <div className="auto-container">
                <div className="wrapper-box  " >
                    <div className="left-column col-lg-6 col-md-12 col-sm-12">
                        <h3 style={{fontSize: '29px'}}>Schedule Your Appointment Today</h3>
                    ...
                    <div className="right-column col-lg-6 col-md-12 col-sm-12" >
                        <div className="phone col-6"  style={{fontSize: '35px'}}>1800.456.7890</div>
                        <div  style={{minWidth: '150px'}} className="btn col-5" ><a href="#" className="theme-btn btn-style-one" style={{fontSize: '11px', minWidth: '150px'}}><span>Appointment</span><i
